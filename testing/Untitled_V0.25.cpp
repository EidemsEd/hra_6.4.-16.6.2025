...
string finbos[12][5];  // textura finálního bosse
...
int php=20, mhp=10, mbhp=50, bhp=125;  // player hp; mob hp, midboss hp; final boss hp
int mbhp1=mbhp;
int kills=0;  // killy
int Bkills=2;  // kolik jsi zabil bossů
...
if(zal[6][1]==" ||z|| " || zal[6][1]==" ||H|% " || zal[6][1]=="(*=*)_ "){
    ...
    if(inman[ades-1][1]==0){
        cout << "chces " << wps[*inman[ades]][0] << stoi(wps[*inman[ades]][1]) << ", " << zal[1][1];
        if(zal[1][1]=="       "){
    ...
    if(inman[ades-1][1]==0){
        ...
        if(enst[1][3]=="       "){
            ...
            gmhp=stoi(enst[1][3]) - stoi(wps[*inman[ades]][1]);
        }
    } else if(inman[ades-1][1]==1){
        cout << "chces " << fwps[*inman[ades-1]][0];
        if(enst[1][3]=="       "){
