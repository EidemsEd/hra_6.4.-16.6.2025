...
int random = 12; // random spawnovani
int sp;
...
int pch=0; // pocet chestek
int mch[5]; // misto chestek
int cpk=1; //pocet kol
...
cout << "- utocit (a), branit (d), healnout se (h); raidnout dum (r), otevrit truhlu(o),skipnout toto a zbyla rozhodnuti(s)        ukoncit (f) -" << endl << "            ";
cin >> des;
switch(des){
    case 'a':
        utok();
